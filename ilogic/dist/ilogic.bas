...
190 PS=0:X=102:Y=64:VY=0:TH=0:TV=0	
...
380 IF X>=224 THEN X=20:R=R+1:PUT SPRITE 0,(X, Y-1),6,0:GOTO 191
381 IF X<=16 THEN X=220:R=R-1:PUT SPRITE 0,(X, Y-1),6,0:GOTO 191
