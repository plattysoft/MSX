...
1521 RU=VPEEK(&H1800+722)
1600 IF RU=253 THEN GOSUB 6500 ELSE GOSUB 7500
...
6100 IF TV=69 THEN GOSUB 6500: VPOKE &H1800+722, 253
6200 IF TV=70 THEN GOSUB 7500: VPOKE &H1800+722, 252
6210 IF TV>70 AND TV<76 THEN GOTO 8000
