...
9211 Y=Y+VY
9212 X=X+VX
9240 TT=&H1800+((X)\8)+((Y+32)\8)*32 ' TODO: Check hit ceiling
9241 'T0 = VPEEK (TT)
9242 'T1 = VPEEK (TT+1)
9243 'T2 = VPEEK (TT+2)
9244 IF VX>0 THEN T3=VPEEK(TT-&H80+2):T4=VPEEK(TT-&H60+2):T5=VPEEK(TT-&H40+2):T6=VPEEK(TT-&H20+2):T7=VPEEK (TT+2)
9245 IF VX<0 THEN T3=VPEEK(TT-&H80):T4=VPEEK(TT-&H60):T5=VPEEK(TT-&H40):T6=VPEEK(TT-&H20):T7=VPEEK (TT)
9246 GOSUB 9900 'VISUAL DEBUG
