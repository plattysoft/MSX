...
9254 IF VX>0 THEN T3=VPEEK(TT-&H80+2):T4=VPEEK(TT-&H60+2):T5=VPEEK(TT-&H40+2):T6=VPEEK(TT-&H20+2)
9255 IF VX<0 THEN T3=VPEEK(TT-&H80):T4=VPEEK(TT-&H60):T5=VPEEK(TT-&H40):T6=VPEEK(TT-&H20)
9281 IF T3>=64 OR T4>=64 OR T5>=64 OR T6>=64 THEN X=X-VX
9299 RETURN
...
9382 IF T0>=64 OR T1>=64 OR T2>=64 THEN GS=1:VX=0:Y=((Y+32)\8)*8-32
9399 RETURN
