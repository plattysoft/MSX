...
9180 IF T0<64 AND T1<64 AND T2<64 THEN IF AT>0 THEN AT=AT-1 ELSE GS=3:VX=0 ELSE AT=3
...
9344 TT = TT + (X+1)\8
9350 IF T0>=64 OR T1>=64 OR T2>=64 THEN GS=1:VX=0:Y=((Y+32)\8)*8-32
