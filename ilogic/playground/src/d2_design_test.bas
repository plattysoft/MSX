...
9105 IF NOT(STRIG(0)) THEN JD=0 ELSE IF JD=0 THEN GS=2:VY=-14:SA=0:ST=4:RETURN 'JD: Jump Debouncing
9106 X=X+VX
...
9382 IF T0>=64 OR T1>=64 OR T2>=64 THEN GS=1:JD=1:SA=4:ST=4:VX=0:Y=((Y+32)\8)*8-32
9399 RETURN
