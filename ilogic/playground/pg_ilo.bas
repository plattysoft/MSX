...
3330 IF TU>31 OR TV>31 OR TW>31 THEN IF VY%>=0 THEN GOTO 3400 ELSE GOTO 3450
...
3650 IF TH>31 OR TI>31 OR TG>31 THEN VX=0
3660 X=X+VX:VX=0
...
4000 IF STRIG(0)=-1 AND PJ%=0 THEN GOSUB 6000
...
6000 TC = VPEEK(&H1800+(X+8)\8+((Y+8)\8)*32)
6100 IF TC>6 AND TC<11 THEN GOSUB 6500
6200 IF TC>10 AND TC<15 THEN GOSUB 7500
6210 IF TC>14 AND TC<20 THEN GOSUB 8000
...
6550   IF CT>6 AND CT<11 THEN VPOKE I, CT+4
6800 NEXT I
6900 RETURN
...
7550   IF CT>10 AND CT<15 THEN VPOKE I, CT-4
7800 NEXT I
7900 RETURN

8000 'Swap the convoy belts
8100 TK=TC+1: IF TK=20 THEN TK=15
8200 FOR I=&H1800 TO &H19FF
8210   CT=VPEEK(I)
8220   IF CT=TC THEN VPOKE I, TK
