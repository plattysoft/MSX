...
333 IF VY%>=0 THEN GOTO 340 ELSE GOTO 345
340 IF TU>31 OR TV>31 OR TW>31 THEN PJ%=0:VY%=0:Y=Y-(Y MOD 8) ELSE PJ%=-1:VY%=VY%+1:IF VY%>8 THEN VY%=8
341 GOTO 350
345 IF TU>31 OR TV>31 OR TW>31 THEN VY%=0:Y=Y+8-(Y MOD 8) ELSE VY%=VY%+1:IF VY%>8 THEN VY%=8
