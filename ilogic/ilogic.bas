...
163 RESTORE 850
164 IF R=0 GOTO 166
165 FORI=1 TO R:FOR K=1 TO 10:READE:FORJ=1TOE:READE,E,E,E,E,E,E,E,E,E:NEXTJ:NEXT K:NEXTI
166 IF C=0 GOTO 170
167 FORI=1 TO C:READE:FORJ=1TOE:READE,E,E,E,E,E,E,E,E,E:NEXTJ:NEXTI
...
480   PUT SPRITE I,(DE(I),AE(I)-16),CE(I),PO(I)-1
481 NEXT I
