...
330 IF FN FF(X+2,Y+16)=1 OR FN FF(X+8,Y+16)=1 OR FN FF(X+12,Y+16)=1 THEN PJ=0:VY=0:Y=Y-(Y MOD 8) ELSE PJ=-1:VY=VY+1:IF VY>8 THEN VY=8
339 GOTO 390
340 IF FN FF(X+2,Y)=1 OR FN FF(X+8,Y)=1 OR FN FF(X+12,Y)=1 THEN VY=0:Y=Y+8-(Y MOD 8) ELSE VY=VY+1:IF VY>8 THEN VY=8
