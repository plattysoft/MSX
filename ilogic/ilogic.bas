...
150 PS%=0:SX=46:SY=80:SV=0:TH=0:TV=0	

151 R$=STR$(R): R$=RIGHT$(R$,LEN(R$)-1)
152 C$=STR$(C): C$=RIGHT$(C$,LEN(C$)-1)
153 'GOSUB 2000
154 BLOAD "map_"+R$+"_"+C$+".scr",S


160 call turbo ON(SX,SY,SV,R,C)
161 'Load enemies for this room
162 DIMAE(3):DIMDE(3):DIMPO(3):DIMTE(3):DIMMM(3):DIMMN(3):DIMME(3):DIMPM(3):DIMPI(3):DIMCE(3)
163 RESTORE 850
164 FORI=1 TO R:READE:FORJ=1TOE:READE,E,E,E,E,E,E,E,E,E:NEXTJ:NEXTI
165 FORI=1 TO C:READE:FORJ=1TOE:READE,E,E,E,E,E,E,E,E,E:NEXTJ:NEXTI
...
380 IF X>=226 THEN X=18:R=R+1:PUT SPRITE 0,(X, Y-1),0,0:GOTO 550
381 IF X<=14 THEN X=222:R=R-1:PUT SPRITE 0,(X, Y-1),0,0:GOTO 550
390 PUT SPRITE 0,(X, Y-1),6,PS%
400 FOR I=1 TO E
410   IF TE(I)=1 THEN 430
420     DE(I)=DE(I)+ME(I)
421     IF DE(I)>MM(I) OR DE(I)<MN(I) THEN ME(I)=-ME(I):DE(I)=MM(I)
422     GOTO 460
430     AE(I)=AE(I)+ME(I)
431     IF AE(I)>MM(I) OR AE(I)<MN(I) THEN ME(I)=-ME(I):AE(I)=MM(I)
432     GOTO 460
460   PO(I)=PO(I)+1
470   IF PO(I)>=PM(I) THEN PO(I)=PI(I)
480   PUT SPRITE I,(DE(I),AE(I)),CE(I),PO(I)
481 NEXT I
