...
9151 IF D=14 THEN T3=VPEEK(TT-&H80-1):T4=VPEEK(TT-&H60-1):T5=VPEEK(TT-&H40-1):T6=VPEEK(TT-&H20-1)
9180 IF T3>=128 OR T4>=128 OR T5>=128 OR T6>=128 THEN X=X-VX
9181 IF VPEEK(TT-32)=96 THEN TI=(TT-64):GOSUB 9810'TODO: Should use T6 (floor) in both directions?
