...
9552 IF I6=1 THEN I6=2:T$="I SWAPPED THE FUSE[#MAIN POWER IS BACK[#I CAN REBOOT THE#SYSTEM^":VPOKE IC+&H1800,154:VPOKE IC+&H1801,155:VPOKE IC+&H1820,186:VPOKE IC+&H1821,187:GOSUB 10300:RETURN ' Got the fuse, put it in place, close the box but do not chnce the VPOKE proxy
9559 RETURN
...
9721 VPOKE &H1800+TI,0:VPOKE &H1801+TI,0
9722 VPOKE &H1820+TI,0:VPOKE &H1821+TI,0
...
9756 IT=&H1800+TT-&H60-1:VPOKE IT,82:VPOKE IT+1,83::VPOKE IT+32,114::VPOKE IT+33,115
