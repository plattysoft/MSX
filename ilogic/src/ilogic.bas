...
9492 IF STRIG(SS) AND JD=0 THEN GS=2:VY=-38:VX=-VX:JD=1:WT=4:CMD PLYSOUND 7:IF D=0 THEN D=14 ELSE D=0'JD: Jump Debouncing
...
9823 IF JD=0 AND STRIG(SS) THEN GS=2:CMD PLYSOUND 8:SA=0:ST=4:JD=1:DJ=1:VY=VY-38:IF VY<-38 THEN VY=-38 ELSE IF VY>-28 THEN VY=-28
9829 RETURN
