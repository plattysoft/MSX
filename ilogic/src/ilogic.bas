...
6100 'TODO Intro sequence
6101 FOR I=0 TO 7:PUT SPRITE I,,0,0:NEXT
6105 CMD WRTSCR 45
6109 CMD RESTORE 43:RESTORE 16:TK=1' Text sKip enabled (pressing space)
...
6150 TY=10:GOSUB 10200
6151 TY=11:GOSUB 10200
6152 TY=12:GOSUB 10200
6170 TY=15:GOSUB 10200
6180 TY=18:GOSUB 10200
6190 TY=22:GOSUB 10200
6191 IF STRIG(0)=0 AND STRIG(1)=0 THEN 10091
6199 ' Move ahead with a timer
