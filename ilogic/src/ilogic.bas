...
9540   A=VPEEK(208*8+8+I-BS*8):VPOKE 121*8+I,A:VPOKE &H800+121*8+I,A:VPOKE &H1000+121*8+I,A
9550 NEXT
...
9581 NEXT
9582 ' And swap the indicator on the console TODO
...
9729 IF TV=66 THEN I2=1:T$="GOT THE ST GLOVE#I CAN HOLD TO#WALLS AND JUMP#FROM THEM":GOSUB 10300 'Wall jump item
...
9732 IF TV=72 THEN I5=1:T$="GOT THE BOOT DISK#I CAN USE RESTORE#THE SYSTEM":GOSUB 10300'ID Card - Brick Swap item
9733 IF TV=74 THEN I6=1:T$="FOUND A FUSE#I CAN USE RESTORE#MAIN POWER":GOSUB 10300'ID Card - Brick Swap item

9739 RETURN

9750 ' fun open fuse box
9751 IF I4=0 THEN T$="THE FUSE BOX IS STUCK##I NEED A TOOL TO#OPEN IT":GOSUB 10300:RETURN
