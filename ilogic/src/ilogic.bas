...
8011 'GOSUB 10000 ' Show the ending
...
10020 T$="MALFOS BOOTING[@[@[@[@[@@@OK":TX=0:TY=1:GOSUB 10200
10021 T$="AUTHENTICATING[@[@[@[@[@@@OK":TX=0:TY=3:GOSUB 10200
10030 T$="@@@SYSTEM ONLINE@@@":TX=0:TY=5:GOSUB 10200
10040 T$="THREAD LEVEL[@[@[@[@[@[@@@LOW@@@":TX=0:TY=8:GOSUB 10200
10050 T$="DISENGAGE LASERS[@[@[@@@OK":TX=0:TY=10:GOSUB 10200
10060 T$="REMOVE SAWS[@[@[@[@[@[@[@[@@@OK":TX=0:TY=11:GOSUB 10200
10070 T$="@@@BOOTING COMPLETED[@@@@":TX=0:TY=14:GOSUB 10200
10080 T$="THANK YOU FOR YOUR ASSISTANCE^@@@@":TX=0:TY=17:GOSUB 10200
10090 T$="HAVE A NICE DAY[":TX=0:TY=21:GOSUB 10200
...
10240   VPOKE &H1800+TX-1+TY*32+I,TT
10244   T=TIME
