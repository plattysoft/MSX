...
8802 EC=0
8803 FOR I=1 TO 4
8804  PUT SPRITE 3+I,(16*I,-16),0,0
8805 NEXT I
8810 FOR I=0 TO &H400
8820  TT=VPEEK(&H1800+I)
8821  IF TT=192 THEN GOSUB 8840:ET(EC)=1:EV(EC)=1:EY(EC)=EY(EC)+1:GOSUB 8850:VPOKE &H1800+I,0:VPOKE &H1800+I+1,0
8822  IF TT=160 THEN GOSUB 8840:ET(EC)=2:EV(EC)=1:EY(EC)=EY(EC)-12:GOSUB 8850:VPOKE &H1800+I,0:VPOKE &H1800+I+1,0
8823  IF TT=163 THEN GOSUB 8840:ET(EC)=3:EV(EC)=1:EY(EC)=EY(EC)-2:EX(EC)=EX(EC)+2:GOSUB 8850:VPOKE &H1800+I,0:VPOKE &H1800+I+32,0
8824  IF TT=162 THEN GOSUB 8840:ET(EC)=4:EV(EC)=1:EY(EC)=EY(EC)-2:EX(EC)=EX(EC)-10:GOSUB 8850:VPOKE &H1800+I,0:VPOKE &H1800+I+32,0
8829 NEXT I
8830 RETURN
...
8850 'PUT SPRITE 3+EC,(EX(EC),EY(EC)),14,25+ES(EC)+ET(EC)*3 'If we uncomment this line, a new enemy shows on room 3?? linked to EC++ on the ET=1
