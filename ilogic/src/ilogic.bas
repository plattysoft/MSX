...
10020 READ T$:TX=0:TY=1:GOSUB 10200
10021 READ T$:TX=0:TY=3:GOSUB 10200
10030 READ T$:TX=0:TY=5:GOSUB 10200
10040 READ T$:TX=0:TY=8:GOSUB 10200
10050 READ T$:TX=0:TY=10:GOSUB 10200
10051 READ T$:TX=0:TY=11:GOSUB 10200
10052 READ T$:TX=0:TY=12:GOSUB 10200
10070 READ T$:TX=0:TY=15:GOSUB 10200
10080 READ T$:TX=0:TY=18:GOSUB 10200
10090 READ T$:TX=0:TY=22:GOSUB 10200
