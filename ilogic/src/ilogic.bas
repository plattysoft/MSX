...
8821  IF TT=192 THEN EX=(I MOD 32)*8:EY=(I\32)*8+1:VPOKE &H1800+I,0:VPOKE &H1800+I+1,0
8830 NEXT I
...
9902 EX=EX+EV
9903 IF EX MOD 8=0 THEN ET=VPEEK(&H1800+((EY+9)\8)*32+(EX+8+4*EV)\8):IF ET=75 OR ET=77 THEN EV=-EV
9999 RETURN
