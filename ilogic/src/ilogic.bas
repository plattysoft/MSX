...
8102 Y=20
8103 DIM EX(4),EY(4),EV(4),ET(4)

8800 ' Parse new room
8801 EC=0
8810 FOR I=0 TO &H400
8820  TT=VPEEK(&H1800+I)
8821  IF TT=192 THEN EC=EC+1:ET(EC)=1:EX(EC)=(I MOD 32)*8:EY(EC)=(I\32)*8+1:VPOKE &H1800+I,0:VPOKE &H1800+I+1,0
8822  IF TT=160 THEN EC=EC+1:ET(EC)=2:EX(EC)=(I MOD 32)*8:EY(EC)=(I\32)*8+1:VPOKE &H1800+I,0:VPOKE &H1800+I+1,0
8830 NEXT I
...
9031 FOR I=1 TO EC
9035  PUT SPRITE 3+I,(EX(I),EY(I)),14,28+ES
9039 NEXT I
9089 ' END GAME LOOP
...
9902 EW=EW+1:IF EW=3 THEN EW=0:ES=ES+EV:IF ES=3 THEN ES=0 ELSE IF ES=-1 THEN ES=2
9905 FOR I=1 TO EC
9906  ON ET(I) GOSUB 9910,9920,9930,9940
9907 NEXT I
9909 RETURN

9910 EX=EX+EV
9911 IF EX MOD 8=0 THEN ET=VPEEK(&H1800+((EY+9)\8)*32+(EX+8+4*EV)\8):IF ET=75 OR ET=77 THEN EV=-EV
9919 RETURN

9920 EX=EX+EV
9921 IF EX MOD 8=0 THEN ET=VPEEK(&H1800+((EY+9)\8)*32+(EX+8+4*EV)\8):IF ET=107 OR ET=109 THEN EV=-EV
9929 RETURN
