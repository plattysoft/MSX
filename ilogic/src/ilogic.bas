...
9933 IF EY(EI) MOD 8=6 THEN EL=VPEEK(&H1800+((EY(EI)+8+6*EV(EI))\8)*32+(EX(EI)+8)\8):IF EL=142 OR EL=174 THEN EY(EI)=EY(EI)-EV(EI):EV(EI)=-EV(EI)
9939 RETURN

9940 'fun Update enemy type 4: Vertical, left wall
9941 EY(EI)=EY(EI)+EV(EI)
9943 IF EY(EI) MOD 8=6 THEN EL=VPEEK(&H1800+((EY(EI)+8+6*EV(EI))\8)*32+(EX(EI))\8):IF EL=141 OR EL=173 THEN EY(EI)=EY(EI)-EV(EI):EV(EI)=-EV(EI)
9949 RETURN
