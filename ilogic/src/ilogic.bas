...
5010 ' --- Slot 0
5020 ' color 14
5030 DATA 00,00,00,00,00,00,00,00,07,1F,3F,7F,7F,FE,FC,F8
5040 DATA 00,00,00,00,00,00,00,00,C0,F0,F8,FC,FC,FE,7E,3E
5050 '
5060 ' --- Slot 1
5070 ' color 14
5080 DATA 00,00,00,00,00,00,00,00,07,1F,3F,7F,7F,FF,F8,FC
5090 DATA 00,00,00,00,00,00,00,00,C0,F0,F8,FC,FC,7E,7E,3E
5100 '
5110 ' --- Slot 2
5120 ' color 14
5130 DATA 00,00,00,00,00,00,00,00,07,1F,3F,7F,7F,FD,FC,FC
5140 DATA 00,00,00,00,00,00,00,00,C0,F0,F8,FC,FC,FE,3E,7E

5160 ' --- Slot 5
5170 ' color 14
5180 DATA 00,00,00,00,00,00,00,00,00,00,00,00,00,00,00,00
5190 DATA 00,07,1F,3F,7F,7F,FE,FC,F8,FC,FE,7F,7F,3F,1F,07
5200 '
5210 ' --- Slot 6
5220 ' color 14
5230 DATA 00,00,00,00,00,00,00,00,00,00,00,00,00,00,00,00
5240 DATA 00,07,1F,3F,7F,7F,FE,F8,FC,FC,FD,7F,7F,3F,1F,07
5250 '
5260 ' --- Slot 7
5270 ' color 14
5280 DATA 00,00,00,00,00,00,00,00,00,00,00,00,00,00,00,00
5290 DATA 00,07,1F,3F,7F,7F,FD,FC,FC,F8,FF,7F,7F,3F,1F,07
...
8821  IF TT=224 THEN EX=(I MOD 32)*8:EY=(I\32)*8-9:VPOKE &H1800+I,0:VPOKE &H1800+I+1,0
8830 NEXT I
...
9030 PUT SPRITE 3,(EX,EY),14,28+ES
9089 ' END GAME LOOP
...
9900 'MOVE ENEMIES
9901 EW=EW+1:IF EW=3 THEN EW=0:ES=ES+EV:IF ES=3 THEN ES=0 ELSE IF ES=-1 THEN ES=2
9902 EX=EX+EV
9903 IF EX MOD 8=0 THEN ET=VPEEK(&H1800+((EY+16)\8)*32+(EX+EV)\8+(EV+1)):IF ET>=64 THEN EV=-EV
9999 RETURN
