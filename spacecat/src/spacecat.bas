...
975 IF C1>64 OR C2>64 OR C3>64 OR C4>64 THEN IF ABS(AY)>1.2 THEN GOTO 1700 ELSE Y=Y-AY:AY=0
976 IF D1>64 OR D2>64 OR D3>64 OR D4>64 THEN IF ABS(AX)>1.2 THEN GOTO 1700 ELSE X=X-AX:AX=0
...
987 IF C1=62 OR C2=62 OR C3=62 OR C4=62 OR D1=62 OR D2=62 OR D3=62 OR D4=62 OR C1=63 OR C2=63 OR C3=63 OR C4=63 OR D1=63 OR D2=63 OR D3=63 OR D4=63 THEN 1700
