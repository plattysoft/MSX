...
300 FOR I=&H1800 TO &H1B00
301   IF VPEEK(I)=24 THEN LT=I:I=&H1B00
302 NEXT I
310 FOR I=&H1800 TO &H1B00
311   IF VPEEK(I)=160 THEN Y=(I\32)*8-30:X=(I MOD 32)*8+8:I=&H1B00
312 NEXT I
...
870 IF TT MOD 20 = 0 THEN GOSUB 1100
...
981 ' TODO: Range for instant kill
988 'IF C2>=169 AND C3>=160 AND AY=0 THEN GOTO 1300
...
1100 ' SWAP LASER STATE
1120 IF VPEEK(LT)=24 THEN FOR J=0 TO 7:VPOKE LT+J, 120+J: NEXT J ELSE FOR J=0 TO 7:VPOKE LT+J, 24+J: NEXT J
1199 RETURN
