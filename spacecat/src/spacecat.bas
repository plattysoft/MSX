...
350 SOUND 8, &B11111: SOUND 9, 0
361 SOUND 7, &B10101000
362 IF LP=0 THEN SOUND 1,0:SOUND 0, 0 ELSE SOUND 1,&H4:SOUND 0,&H80
364 SOUND 11,&H80
365 SOUND 12,&H04
366 SOUND 13, 12
367 SOUND 6, &B01101
...
1180 IF LC=0 THEN SOUND 8, 0 ELSE SOUND 8, &B11111
1199 RETURN
...
1900 PUT SPRITE 3,,0:SOUND 8,0:SOUND 9,0
...
1945 IF STRIG(SS) THEN IF Y=32 THEN BLOAD"loading.sc2",S: GOSUB 2000: RUN"lselect.bas" ELSE IF Y=0 THEN L=L+1: GOTO 190 ELSE GOTO 190
1950 GOTO 1940
...
1972 IF STRIG(SS) THEN IF Y=16 THEN BLOAD"loading.sc2",S: GOSUB 2000: RUN"lselect.bas" ELSE GOTO 190
1980 GOTO 1960

2000 ' SAVE LEVEL VALUES (needs to be done on each exit to prevent problems when you only see the game over dialog)
2010 FOR I=0 TO 23 STEP 2
2020  VPOKE I\2+2, (LS(I)+1)*16+(LS(I+1)+1)
2030 NEXT I
2040 VPOKE 0, L
2050 VPOKE 1, SS
2060 RETURN
