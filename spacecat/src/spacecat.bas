...
1945 IF STRIG(SS) THEN IF Y=32 THEN run"lselect.bas" ELSE IF Y=0 THEN L=L+1: GOTO 190 ELSE GOTO 190
1950 GOTO 1940
...
1972 IF STRIG(SS) THEN IF Y=16 THEN RUN"lselect.bas" ELSE GOTO 190
1980 GOTO 1960
