...
1901 'SPRITE OFF
1902 RESTORE 1891
1908 FOR I=&H1800+&H20*8 TO &H1800+&H20*15 STEP &H20: FOR J=8 TO 23: READ V:VPOKE I+J,V:NEXT J:NEXT I
1909 M=0:GOTO 1910

1910 CALL TURBO OFF
1920 IF M=-1 GOTO 1960
1921 LS(L)=L MOD 4
1922 FOR I=0 TO 23 STEP 2
1923  VPOKE I\2+1, (LS(I)+1)*16+(LS(I+1)+1)
1924 NEXT I
1930 L=L+1
1940 IF STRIG(0) THEN run"start.bas"
1950 GOTO 1940

1960 PUT SPRITE 0, (111, 96+Y), 10, 12
1970 S=STICK(0)
1971 IF S<>R THEN R=S: IF S<>0 THEN IF Y=16 THEN Y=0 ELSE Y=16
1972 IF STRIG(0) THEN IF Y=16 THEN RUN"start.bas" ELSE GOTO 300
1980 GOTO 1960
