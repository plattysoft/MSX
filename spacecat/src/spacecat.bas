...
760 IF BD=0 AND BR=0 AND BL=0 THEN SOUND 9,0 ELSE SOUND 9, 8
...
1700 PUT SPRITE 0,,,15: SOUND 8, 0
1701 TIME=0
...
1900 PUT SPRITE 0,,,0: SOUND 8, 0
1901 TIME=0:AX=-1:YY=Y
1902 'JUMP, SMILE and LAND
1903 AX=AX+.05:YY=YY+AX
1904 PUT SPRITE 0,(X,YY)
1905 IF TIME MOD 4 <> 0 GOTO 1905
1906 IF YY<Y GOTO 1903
1907 PUT SPRITE 0,,,2
1910 IF TIME<100 GOTO 1910

1911 PUT SPRITE 0,,0: ßßPUT SPRITE 1,(72,75),0,13: PUT SPRITE 2,(72,75+16),0,14: PUT SPRITE 3,(72,75+32),0,13
1912 RESTORE 1891
