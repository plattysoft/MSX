...
840 Y=Y+AY
850 TT=TT+1
860 IF TT MOD 5 = 0 THEN GOSUB 1200: CS=CS+1: IF CS=4 THEN CS=0
...
1200 'ANIMATE LASER, we have 4 patterns, they all have the same colors, tile 144-147
1210 LT=LT+1:IF LT=148 THEN LT=144
1220 FOR I=0 TO 7
1230  LL=VPEEK(LT*8+I)
