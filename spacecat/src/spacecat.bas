...
1000 PUT SPRITE 0,,0
1001 PUT SPRITE 1,(72,75),0,13: PUT SPRITE 2,(72,75+16),0,14: PUT SPRITE 3,(72,75+32),0,13
1002 RESTORE 1091
1003 M=-1
1009 FOR I=&H1800+&H20*8 TO &H1800+&H20*15 STEP &H20: FOR J=8 TO 23: READ V:VPOKE I+J,V:NEXT J:NEXT I
1010 GOTO 1910
1091 ' TEST OVER DIALOG (RETRY / MENU)
1091 DATA 10,11,11,11,11,11, 11, 11, 11, 11, 11, 11, 11, 11, 11,12
1092 DATA 13,14,14,14,14,13,223,217,222,223, 14,220,250,217,221,15
1093 DATA 13,14,14,14,14,13, 17, 17, 17, 17, 17, 17, 17, 17, 17,15
1094 DATA 13,40,41,42,14,13, 14, 14, 14, 14, 14, 14, 14, 14, 14,15
1095 DATA 13,43,44,45,14,13, 14, 14,221,217,223,221,252, 14, 14,15
1096 DATA 13,46,47,48,14,13, 14, 14, 14, 14, 14, 14, 14, 14, 14,15
1097 DATA 13,14,14,14,14,13, 14, 14,218,217,219,249, 14, 14, 14,15
...
1904 PUT SPRITE 1,(72,75),0,13: PUT SPRITE 2,(72,75+16),0,14: PUT SPRITE 3,(72,75+32),0,13
...
1923  VPOKE I\2+1, (LS(I)+1)*16+(LS(I+1)+1)
1924 NEXT I
1925 IF M=-1 GOTO 1960
...
1945 IF STRIG(0) THEN IF Y=32 THEN run"start.bas" ELSE IF Y=0 THEN L=L+1: GOTO 190 ELSE GOTO 190
1950 GOTO 1940

1960 PUT SPRITE 0, (112, 95+Y), 10, 12
1970 S=STICK(0)
1971 IF S<>R THEN R=S: IF S<>0 THEN IF Y=16 THEN Y=0 ELSE Y=16
1972 IF STRIG(0) THEN IF Y=16 THEN RUN"start.bas" ELSE GOTO 190
1980 GOTO 1960
