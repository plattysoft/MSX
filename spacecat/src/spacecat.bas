...
311   IF VPEEK(I)=160 THEN X=(I MOD 32)*8+8:Y=((I-&H1800)\32)*8-28:I=&H1B00
312 NEXT I
...
985 ' TODO: Range for instant kill (120-128)
988 'IF C2>=169 AND C3>=160 AND AY=0 THEN GOTO 1300 TODO Range for finish pad
...
1100 ' SWAP LASER STATE color at 176-179, 126, 127, 158, 159, from CB to 00 and 6A to 60, color table starts at &H2000
1120 IF LS=1 THEN LC=&H00:LS=0 ELSE LC=&HCB:LS=1
1150 FOR I=&H2000+176*8 TO &H2000+179*8 
