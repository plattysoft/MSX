...
110 TM = 72
11 'Rank is 0 for F, 1 for E... 3 for C (minimum for certified pilot) ...6 for S
111 RK = TM \ 12

120 IF TM=72 THEN VPOKE &H1800+10*32+19, 114 ELSE VPOKE &H1800+10*32+19, 101-RK
121 IF TM MOD 12 > 6 THEN VPOKE &H1800+10*32+20, 43
190 TD = TM \ 10
191 TU = TM MOD 10
200 IF TD > 0 THEN VPOKE &H1800+13*32+19, 33+TD: VPOKE &H1800+13*32+20, 33+TU ELSE VPOKE &H1800+13*32+19, 33+TU
