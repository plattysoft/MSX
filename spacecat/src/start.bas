...
4120 SS=S
4121 S=STICK(0)
4122 IF S=SS GOTO 4121
4130 IF S=1 THEN Y=Y-40: IF Y<8 THEN Y=8
4140 IF S=3 THEN X=X+40: IF X>208 THEN X=208
4150 IF S=5 THEN Y=Y+40: IF Y>128 THEN Y=128
4160 IF S=7 THEN X=X-40: IF X<8 THEN X=8

4320 PUT SPRITE 0,(X,Y-1),10,0
4330 PUT SPRITE 1,(X+24,Y-1),10,1
4340 PUT SPRITE 2,(X,Y+23),10,2
4350 PUT SPRITE 3,(X+24,Y+23),10,3
