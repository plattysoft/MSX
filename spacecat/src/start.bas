...
4120 PUT SPRITE 0,(X,Y-1),10,0
4130 PUT SPRITE 1,(X+24,Y-1),10,1
4140 PUT SPRITE 2,(X,Y+23),10,2
4150 PUT SPRITE 3,(X+24,Y+23),10,3

4220 SS=S
4221 S=STICK(0)
4222 IF S=SS GOTO 4221
4230 IF S=1 THEN Y=Y-40: IF Y<8 THEN Y=8
4240 IF S=3 THEN X=X+40: IF X>208 THEN X=208
4250 IF S=5 THEN Y=Y+40: IF Y>128 THEN Y=128
4260 IF S=7 THEN X=X-40: IF X<8 THEN X=8
