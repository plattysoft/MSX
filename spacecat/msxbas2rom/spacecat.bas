...
2946 IF STRIG(SS) THEN IF Y=32 THEN CMD WRTVRAM 25,0: GOSUB 3000: GOTO 4100 ELSE IF Y=0 THEN L=L+1: GOTO 190 ELSE GOTO 190
2950 GOTO 2940
...
2972 IF STRIG(SS) THEN IF Y=16 THEN CMD WRTVRAM 25,0: GOSUB 3000: GOTO 4100 ELSE GOTO 190
2980 GOTO 2960
...
3020  VPOKE I\2+2, (LL(I)+1)*16+(LL(I+1)+1)
3030 NEXT I
3040 VPOKE 0, L
3050 VPOKE 1, SS
3060 RETURN
...
4510 CMD WRTVRAM 0,24
4519 'Put level selection in VRAM info
4520 VPOKE 0, SL
4521 VPOKE 1, SS
4522 FOR I=0 TO 23 STEP 2
4523  VPOKE I/2+2, (LL(I)+1)*16+(LL(I+1)+1)
4525 NEXT I
4590 GOTO 100
