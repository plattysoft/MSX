...
3033 PT=&H19AC:NT=0:GOSUB 765:PT=&H1840+26:NT=82:GOSUB 765
3034 PUT SPRITE 1,,0:PUT SPRITE 2,,0:PUT SPRITE 3,,0
3036 RETURN 3200

3040 CMD PLYSOUND 3
3041 PT=&H19AC:NT=0:GOSUB 765:PT=&H1840+26:NT=82:GOSUB 765'remove the item, mark it within items
...
3900 BS=1*6-3
3910 Y=Y-2:TIME=0
3911 WS=(WS+1) MOD 8:WT=WS\2:IF WT=2 OR WT=0 THEN CS=4 ELSE IF WT=1 THEN CS=0 ELSE CS=2
3912 IF WS=1 THEN CMD PLYSOUND 6
3913 CS=BS+CS
3914 PUT SPRITE 1,(X,Y),5,CS:PUT SPRITE 2,(X,Y),15,CS+1:PUT SPRITE 3,(X,Y),1,2
3915 IF TIME<2 THEN 3915 ELSE IF Y>FY THEN 3910
3921 PUT SPRITE 1,(X,FY),5,19:PUT SPRITE 2,(X,FY),15,20:PUT SPRITE 3,(X,FY),1,2
3922 RETURN
