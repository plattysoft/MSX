...
414 'IF T1=113 THEN PT=PT-64:GOSUB 760
415 IF T1=178 AND I1=1 THEN PT=PT-64:NT=82:GOSUB 760
419 GOTO 490
420 IF VPEEK(PT-96)<64 AND VPEEK(PT-95)<64 THEN GS=3:MS=8:PUT SPRITE 2,(X,Y-17),9,0:PP=PT-64:PF=PP-32:CS=9' This should exit via another route, not 490
429 GOTO 490
...
434 'IF T1=81 THEN PT=PT+2:GOSUB 760
435 IF T1=146 AND I1=1 THEN PT=PT+2:NT=82:GOSUB 760
439 GOTO 490
440 IF VPEEK(PT+4)<64 AND VPEEK(PT+36)<64 THEN GS=3:MS=8:PUT SPRITE 2,(X+16,Y-1),9,0:PP=PT+2:PF=PP+1:CS=15' This should exit via another route, not 490
449 GOTO 490
...
454 'IF T1=81 THEN PT=PT+64:GOSUB 760
455 IF T1=146 AND I1=1 THEN PT=PT+64:NT=82:GOSUB 760
459 GOTO 490
460 IF VPEEK(PT+128)<64 AND VPEEK(PT+129)<64 THEN GS=3:MS=8:PUT SPRITE 2,(X,Y+15),9,0:PP=PT+64:PF=PP+32:CS=21' This should exit via another route, not 490
469 GOTO 490
...
474 'IF T1=147 THEN PT=PT-2:GOSUB 760
475 IF T1=147 AND I1=1 THEN PT=PT-2:NT=82:GOSUB 760
479 GOTO 490
480 IF VPEEK(PT-3)<64 AND VPEEK(PT+29)<64 THEN GS=3:MS=8:PUT SPRITE 2,(X-16,Y-1),9,0:PP=PT-2:PF=PP-1:CS=27' This should exit via another route, not 490
489 GOTO 490
