...
586 IF T1=88 AND I2=0 THEN I2=1:GOSUB 780 ' Pick up the battery
587 IF T1=90 THEN MP=1:GOSUB 780:CMD PLYSOUND 3:GOSUB 1430
...
1420 D1$="GOT A MACHETE[":D2$="I CAN CLEAR CUT":D3$="THE WAY"
1421 GOSUB 1300
1429 RETURN

1430 D1$="GOT A MAGNET[":D2$="NOW I CAN PUSH":D3$="METAL CRATES"
1431 GOSUB 1300
1439 RETURN

1440 D1$="GOT A BATTERY[":D2$="I SHOULD TAKE":D3$="IT SOMEWHERE"
1441 GOSUB 1300
1449 RETURN

1450 D1$="GOT A HAMMER[":D2$="NOW I CAN CRUSH":D3$="WEAK WALLS"
1451 GOSUB 1300
1459 RETURN
