...
652 GS=1
653 VPOKE PF,130:VPOKE PF+1,131:VPOKE PF+32,162:VPOKE PF+33,163:PUT SPRITE 2,(0,0),0,0
654 IF TL(PF-&H1800)=19 THEN GOSUB 660' open door
655 IF TL(PP-&H1800)=19 THEN GOSUB 670 'Close door
659 RETURN
