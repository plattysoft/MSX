...
270 'RR=1:RC=2:RH=1':I1=1:I5=1:I2=0:MP=1:I4=1
271 RR=4:RC=2:RH=0
272 GOSUB 900
...
404 IF SR=10 THEN SR=0:GOSUB 1050: RETURN 300
409 RETURN
...
586 IF T1=94 THEN IF I2=1 THEN I2=2:GOSUB 820:CMD PLYSOUND 3:GOSUB 1412 ELSE IF I2=0 THEN CMD PLYSOUND 3:GOSUB 1418 'batteries in place, swap colors / step on empty battery
...
632 IF MD=1 AND (VPEEK(PF+63)=39 OR VPEEK(PF+63)=238) THEN OT=0:NT=39:IT=PF+64:GOSUB 800:GOSUB 1100:RETURN 300' Lasers are back (to the right) and we die
633 IF MD=3 AND (VPEEK(PF-33)=39 OR VPEEK(PF-33)=238) THEN OT=0:NT=39:IT=PF-32:GOSUB 800:GOSUB 1100:RETURN 300' Lasers are back (to the right) and we die
...
1418 T$="THE BATTERY IS#EMPTY[#I NEED TO FIND#A NEW ONE["
1419 GOSUB 1300:RETURN
