...
414 IF T1=60 AND T2=60 THEN RR=RR-1:Y=176: GOSUB 740
...
434 IF T1=61 AND T2=61 THEN RC=RC+1:X=0: GOSUB 740
...
454 IF T1=62 AND T2=62 THEN RR=RR+1:Y=0: GOSUB 740
...
474 IF T1=63 AND T2=63 THEN RC=RC-1:X=176: GOSUB 740
