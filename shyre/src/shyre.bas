...
3250 CMD WRTSCR 0
3201 T$="A FEW HOURS LATER...":TY=7:GOSUB 1290
...
3906 IF TIME<2 THEN 3906 ELSE IF Y>FY THEN 3901
3908 PUT SPRITE 1,(X,FY),4,19:PUT SPRITE 2,(X,FY),15,20:PUT SPRITE 3,(X,FY),1,2
3909 RETURN

4000 STRIG(0) OFF: STRIG(1) OFF: RETURN 3899
