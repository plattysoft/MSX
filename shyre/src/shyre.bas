...
439 GOTO 490
440 IF VPEEK(PT+4)<64 AND VPEEK(PT+36)<64 THEN GS=3:MS=8:PUT SPRITE 2,(X+16,Y-1),PC,PS:PP=PT+2:PF=PP+1:CS=8' This should exit via another route, not 490
449 GOTO 490
...
479 GOTO 490
480 IF VPEEK(PT-3)<64 AND VPEEK(PT+29)<64 THEN GS=3:MS=8:PUT SPRITE 2,(X-16,Y-1),PC,PS:PP=PT-2:PF=PP-1:CS=20' This should exit via another route, not 490
489 GOTO 490
