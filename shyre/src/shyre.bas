...
270 'RR=0:RC=4:RH=2:I1=1:I5=1:I2=2
271 RR=4:RC=2:RH=0
272 GOSUB 900
...
1251 CMD WRTSCR 0' THE END Screen

1260 T$="YOU RETURNED TO THE SHIP#JUST IN TIME[":CMD WRTSCR 0:TY=4:GOSUB 1290
...
3000 'GOTO 3900 'intro sequence, uncomment this line to temporary skip
3001 CMD WRTSCR 0
...
3040 CMD PLYSOUND 3:PT=&H19AC:NT=0:GOSUB 765:PT=&H1840+26:NT=82:GOSUB 765'remove the item, mark it within items
3041 PUT SPRITE 1,,,CS:PUT SPRITE 2,,,CS+1:PUT SPRITE 3,,,2
3042 T$="THE MULTIPAD IS USED #TO RECORD DATA AND    #TELEPORT[":TX=2:TY=7:GOSUB 1900
3043 TIME=0
3044 IF TIME<100 THEN 3044

3100 I=0 'talk with the cat and teleport
3101 T$="TAKE CARE OF THE SHIP#UNTIL I\M BACK[       #         ":TX=2:TY=7:GOSUB 1900
3102 TX=2:TY=7:GOSUB 1900

3103 CS=23+(I MOD 4):I=I+1
3108 PUT SPRITE 2,(50,170),14,CS
3109 IF TIME<10 THEN 3109 ELSE IF I<16 THEN TIME=0:GOTO 3101 ELSE I=0
3110 CS=27+(I MOD 4):I=I+1
...
3900 PUT SPRITE 0,(0,-17):PUT SPRITE 1,(0,-17):PUT SPRITE 2,(0,-17):PUT SPRITE 3,(0,-17):CMD WRTSCR 0
3999 RETURN 250
