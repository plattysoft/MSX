...
1371 TX=6:TY=9:T$=D1$:GOSUB 1900
1372 TX=6:TY=11:T$=D2$:GOSUB 1900
1373 TX=6:TY=13:T$=D3$:GOSUB 1900
1379 IF NOT STRIG(SS) THEN 1371

1380 ' Dismiss
1382 KS=&H1905
1383 FOR I=0 TO 9 'Rows
1384   FOR J=0 to 16 'Columns
1385     VPOKE KS+I*32+J, KT(I*17+J)
1386   NEXT J
1387 NEXT I

1390 RETURN

1400 D1$="THIS CRATE IS":D2$="TOO HEAVY[":D3$="CANNOT MOVE IT"
1410 GOSUB 1300
1420 RETURN
