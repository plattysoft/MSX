...
414 IF T1=9 AND T2=9 THEN RR=RR-1:Y=176: GOSUB 740
416 IF T1=178 AND I1=1 THEN PT=PT-64:NT=30:GOSUB 760
...
434 IF T1=8 AND T2=8 THEN RC=RC+1:X=0: GOSUB 740
436 IF T1=146 AND I1=1 THEN PT=PT+2:NT=30:GOSUB 760
...
454 IF T1=11 AND T2=11 THEN RR=RR+1:Y=0: GOSUB 740
456 IF T1=146 AND I1=1 THEN PT=PT+64:NT=30:GOSUB 760
...
474 IF T1=10 AND T2=10 THEN RC=RC-1:X=176: GOSUB 740
476 IF T1=147 AND I1=1 THEN PT=PT-2:NT=30:GOSUB 760
...
749 GOTO 660' TODO Better to make space for this without a GOSUB
...
1111 X=IX:Y=IY:GS=2:MD=ID:CS=14'Remember starting position on a room
1120 GOSUB 750
1130 RETURN
