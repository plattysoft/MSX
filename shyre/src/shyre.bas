...
416 IF T1=60 THEN RH=RH+1:GOSUB 750
417 IF T1=62 THEN RH=RH-1:GOSUB 750
...
436 IF T1=28 THEN RH=RH+1:GOSUB 750
437 IF T1=30 THEN RH=RH-1:GOSUB 750
...
456 IF T1=28 THEN RH=RH+1:GOSUB 750
457 IF T1=30 THEN RH=RH-1:GOSUB 750
...
476 IF T1=29 THEN RH=RH+1:GOSUB 750
477 IF T1=31 THEN RH=RH-1:GOSUB 750
480 IF VPEEK(PT-3)<64 AND VPEEK(PT+29)<64 THEN GS=3:MS=8:PUT SPRITE 2,(X-16,Y-1),9,0:PP=PT-2:PF=PP-1:CS=27
489 GOTO 490

490 IF T1=28 THEN RH=RH+1:GOSUB 750
491 IF T1=30 THEN RH=RH-1:GOSUB 750
...
900 'FIND ENEMY SPAWN POINT (TILES 7-10)
910 FOR I=0 TO 767
920   T=VPEEK(&H1800+I)
