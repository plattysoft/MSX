...
660 FOR I=0 TO 767
661   IF TL(I)=CT THEN TL(I)=NT:TL(I+1)=NT+1:TL(I+32)=NT+32:TL(I+33)=NT+33:VPOKE &H1800+I,NT:VPOKE &H1800+I+1,NT+1:VPOKE &H1800+I+32,NT+32:VPOKE &H1800+I+33,NT+33:RETURN
662 NEXT I
663 RETURN
