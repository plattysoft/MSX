...
419 GOTO 490
420 IF VPEEK(PT-96)<60 AND VPEEK(PT-95)<60 THEN GS=3:MS=8:CMD PLYSOUND 7:PUT SPRITE 2,(X,Y-17),PC,PS:PP=PT-64:PF=PP-32:CS=2' This should exit via another route, not 490
429 GOTO 490
...
439 GOTO 490
440 IF VPEEK(PT+4)<60 AND VPEEK(PT+36)<60 THEN GS=3:MS=8:CMD PLYSOUND 7:PUT SPRITE 2,(X+16,Y-1),PC,PS:PP=PT+2:PF=PP+1:CS=8' This should exit via another route, not 490
449 GOTO 490
...
459 GOTO 490
460 IF VPEEK(PT+128)<60 AND VPEEK(PT+129)<60 THEN GS=3:MS=8:CMD PLYSOUND 7:PUT SPRITE 2,(X,Y+15),PC,PS:PP=PT+64:PF=PP+32:CS=14' This should exit via another route, not 490
469 GOTO 490
...
479 GOTO 490
480 IF VPEEK(PT-3)<60 AND VPEEK(PT+29)<60 THEN GS=3:MS=8:CMD PLYSOUND 7:PUT SPRITE 2,(X-16,Y-1),PC,PS:PP=PT-2:PF=PP-1:CS=20' This should exit via another route, not 490
489 GOTO 490
...
588 'IF T1=18 THEN CT=144:NT=16:GOSUB 670 'Open magenta door
591 'IF T1=22 THEN CT=148:NT=20:GOSUB 670 'Open cyan door
592 'IF TT=18 THEN CT=16:NT=144:GOSUB 670 'Close magenta door
593 'IF TT=22 THEN CT=20:NT=148:GOSUB 670 'Close cyan door
599 RETURN
...
651 IF MS>6 OR MS<=2 THEN CS=24+MD*4 ELSE CS=22+MD*4' Implement common for all directions
...
670 FOR I=0 TO 734 STEP 32
671  FOR J=0 TO 23
672   IF TL(I+J)=CT THEN PT=&H1800+I+J:GOSUB 760:RETURN
673  NEXT J:NEXT I
674 RETURN
