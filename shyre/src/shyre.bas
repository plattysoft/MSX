...
3034 CS=BS+CS
3038 PUT SPRITE 1,(X,Y),,CS:PUT SPRITE 2,(X,Y),,CS+1:PUT SPRITE 3,(X,Y),,2
...
3100 'talk with the cat and teleport
3110 I=0
3120 PUT SPRITE 0,(X,Y),7,I+43
3150 I=I+1
3180 IF TIME<4 THEN GOTO 3180 ELSE IF I<4 THEN TIME=0:GOTO 3120
3181 PUT SPRITE 2,,0:PUT SPRITE 3,,0:PUT SPRITE 1,,0
