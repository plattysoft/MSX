...
490 ' Other checks
491 TT=VPEEK(PT)
492 IF T1<128 AND T2<128 THEN GS=2:MS=4:BS=MD*6-3:CMD PLYSOUND 6:GOSUB 500
493 IF GS=3 THEN BS=23+MD*4:VPOKE PP,TL(PP-&H1800):VPOKE PP+1,TL(PP+1-&H1800):VPOKE PP+32,TL(PP+32-&H1800):VPOKE PP+33,TL(PP+33-&H1800)
494 RETURN

495 GS=2:MS=4:BS=MD*6-3:GOSUB 740:RETURN
...
3024 TIME=0:PUT SPRITE 1,(X,Y),5,15:PUT SPRITE 2,(X,Y),15,16:PUT SPRITE 3,(X,Y),1,2
