...
276 NEXT I
280 X=16:Y=16:GS=1:MD=1:ES=1:CR=1
...
413 IF T1=9 AND T2=9 THEN CR=CR-5:Y=176: CMD WRTSCR CR
419 GOTO 490
...
433 IF T1=8 AND T2=8 THEN CR=CR+1:X=0: CMD WRTSCR CR
439 GOTO 490
...
453 IF T1=7 AND T2=7 THEN CR=CR+5:Y=0: CMD WRTSCR CR
459 GOTO 490
...
473 IF T1=10 AND T2=10 THEN CR=CR-1:X=176: CMD WRTSCR CR
479 GOTO 490
