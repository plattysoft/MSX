...
437 IF T1=150 AND I5=1 THEN PT=PT+2:NT=70:GOSUB 760
439 GOTO 490
...
477 IF T1=151 AND I5=1 THEN PT=PT-2:NT=70:GOSUB 760
479 GOTO 490
...
791 IF MP=1 THEN PT=&H1860+27:NT=90:GOSUB 760
792 IF I1=1 THEN PT=&H1860+25:NT=86:GOSUB 760
793 IF I2=1 THEN PT=&H1860+29:NT=88:GOSUB 760
794 IF I4=1 THEN PT=&H18C0+27:NT=92:GOSUB 760
795 IF I5=1 THEN PT=&H18C0+25:NT=84:GOSUB 760
799 RETURN
...
943   IF I2=1 AND T=88 THEN PT=&H1800+I:NT=0:GOSUB 760
