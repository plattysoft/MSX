...
296 PUT SPRITE 1,,5,CS:PUT SPRITE 2,,15,CS+1:PUT SPRITE 3,(X,Y),1,2
297 T$="COMS ARE JAMMED[#NEED TO FIND A#WAY BACK[":GOSUB 1300

300 TIME=0' BEGIN GAME LOOP
301 ON GS GOSUB 400,500,600,700,720

389 PUT SPRITE 1,(X,Y),5,CS:PUT SPRITE 2,(X,Y),15,CS+1:PUT SPRITE 3,(X,Y),1,2
...
3184 PUT SPRITE 1,,0:PUT SPRITE 2,,0:PUT SPRITE 3,,0
...
3301 CMD WRTSCR 46
3323 X=88:Y=144:BS=19
3324 TIME=0:PUT SPRITE 1,(X,Y),5,BS:PUT SPRITE 2,(X,Y),15,BS+1:PUT SPRITE 3,(X,Y),1,2
3325 T$="A ELECTRIC STORM#IS COMING[#TAKING SHELTER#ON LARGE RUINS[":TY=7:GOSUB 1300

3330 FY=0:GOSUB 3900
...
3900 BS=1*6-3
3901 Y=Y-2:TIME=0
3902 WS=(WS+1) MOD 8:WT=WS\2:IF WT=2 OR WT=0 THEN CS=4 ELSE IF WT=1 THEN CS=0 ELSE CS=2
3903 IF WS=1 THEN CMD PLYSOUND 6
3904 CS=BS+CS
3905 PUT SPRITE 1,(X,Y),4,CS:PUT SPRITE 2,(X,Y),15,CS+1:PUT SPRITE 3,(X,Y),1,2
3906 IF TIME<2 THEN 3906 ELSE IF Y>FY THEN 3901 ELSE RETURN
