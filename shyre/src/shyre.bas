...
1371 TX=4:TY=9:T$=D1$:GOSUB 1900
1372 TX=4:TY=11:T$=D2$:GOSUB 1900
1373 TX=4:TY=13:T$=D3$:GOSUB 1900
...
1400 D1$="THIS METAL CRATE":D2$="IS TOO HEAVY[":D3$="I CAN\T MOVE IT"
1401 GOSUB 1300:RETURN

1410 D1$="A SMALL TREE[":D2$="I COULD CUT IT":D3$="WITH A TOOL"
1411 GOSUB 1300:RETURN

1412 D1$="BATTERY PLUGGED[":D2$="THE SYSTEM IS":D3$="WORKING AGAIN"
1413 GOSUB 1300:RETURN

1414 D1$="THE WALL IS WEAK":D2$="I COULD BREAK IT":D3$="WITH A TOOL"
1415 GOSUB 1300:RETURN

1416 D1$="THE TRANSMITTER":D2$="IS OFF[":D3$="IT NEEDS ENERGY"
1417 GOSUB 1300:RETURN

1420 D1$="FOUND A MACHETE[":D2$="NOW I CAN CLEAR":D3$="CUT TREES"
1421 GOSUB 1300:RETURN

1430 D1$="FOUND A BATTERY[":D2$="I SHOULD PLUG IT":D3$="SOMEWHERE"
1431 GOSUB 1300:RETURN

1440 D1$="FOUND A MAGNET[":D2$="NOW I CAN PUSH":D3$="METAL CRATES"
1441 GOSUB 1300:RETURN

1450 D1$="FOUND A HAMMER[":D2$="NOW I CAN BREAK":D3$="WEAK WALLS"
1451 GOSUB 1300:RETURN

1460 D1$="FOUND A MAP[":D2$="NOW I CAN SEE":D3$="WHERE I AM"
...
1941   VPOKE &H1800+TX-1+TY*32+I, TT
1950 NEXT I
1990 RETURN
