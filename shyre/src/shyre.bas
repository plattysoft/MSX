...
280 X=88:Y=144:GS=1:MD=1:CS=20:WS=0
...
3023 X=96:Y=170:CS=3*9-7
3024 TIME=0:PUT SPRITE 2,(X,Y),5,CS+1:PUT SPRITE 3,(X,Y),15,CS+2:PUT SPRITE 1,(X,Y),1,CS
3025 IF TIME<25 THEN 3025

3030 Y=Y-2
3033 WS=(WS+1) MOD 8:WT=WS\2:IF WT=2 OR WT=0 THEN CS=6 ELSE IF WT=1 THEN CS=0 ELSE CS=3
3034 CS=2+CS
3038 PUT SPRITE 2,(X,Y),5,CS+1:PUT SPRITE 3,(X,Y),15,CS+2:PUT SPRITE 1,(X,Y),1,CS
