...
419 GOTO 490
420 IF VPEEK(PT-96)<60 AND VPEEK(PT-95)<60 THEN GS=3:MS=8:CMD PLYSOUND 7:PUT SPRITE 2,(X,Y-17),PC,PS:PP=PT-64:PF=PP-32 ELSE GS=4:MS=8' This should exit via another route, not 490
429 GOTO 490
...
439 GOTO 490
440 IF VPEEK(PT+4)<60 AND VPEEK(PT+36)<60 THEN GS=3:MS=8:CMD PLYSOUND 7:PUT SPRITE 2,(X+16,Y-1),PC,PS:PP=PT+2:PF=PP+1 ELSE GS=4:MS=8' This should exit via another route, not 490
449 GOTO 490
...
459 GOTO 490
460 IF VPEEK(PT+128)<60 AND VPEEK(PT+129)<60 THEN GS=3:MS=8:CMD PLYSOUND 7:PUT SPRITE 2,(X,Y+15),PC,PS:PP=PT+64:PF=PP+32 ELSE GS=4:MS=8' This should exit via another route, not 490
469 GOTO 490
...
479 GOTO 490
480 IF VPEEK(PT-3)<60 AND VPEEK(PT+29)<60 THEN GS=3:MS=8:CMD PLYSOUND 7:PUT SPRITE 2,(X-16,Y-1),PC,PS:PP=PT-2:PF=PP-1 ELSE GS=4:MS=8' This should exit via another route, not 490
489 GOTO 490
