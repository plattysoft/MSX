...
501 SOUND 1,&H7:SOUND 0,&HF2:SOUND 12,28:SOUND 13,0
502 X=120:XM=0
503 VPOKE &H18C2, 28:VPOKE &H18A3, 30
505 FOR J=0 TO 2
510 FOR VY%=-8 TO 8
511   Y=Y+VY%: VY%=VY%+1
512   IF X<80 AND XM=0 THEN XM=1: VPOKE &H18C4, 29: VPOKE &H18C2, 24
...
540 NEXT VY%
545 NEXT J
546 VPOKE &H18C4, 25:VPOKE &H18A3, 26
550 ' Walk off screen?
554 VPOKE &H18C4, 29
