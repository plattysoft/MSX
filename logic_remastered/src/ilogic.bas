...
382 IF Y>=112 THEN Y=0:R=R+1:GOTO 700
383 IF Y<=-4 THEN Y=114:R=R-1:GOTO 700
...
551 'IF VPEEK (&H1800+512+66+4*K) <= 32 THEN RETURN
560 VPOKE &H1800+512+66+2*K, 20+4*K
561 VPOKE &H1800+512+67+2*K, 21+4*K
562 VPOKE &H1800+512+98+2*K, 22+4*K
563 VPOKE &H1800+512+99+2*K, 23+4*K
590 RETURN
