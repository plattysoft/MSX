...
153 IF R=0 AND C=10 GOTO 850
154 BLOAD "map_"+C$+"_"+R$+".scr",S
155 GOSUB 670

160 call turbo ON(SX,SY,SV,SJ,R,C,PL,S,TR)
...
199 X=SX:Y=SY:VY=SV:PJ=SJ:TH=0:TV=0:SPRITE ON:PUT SPRITE 0,(X,Y-1),6,PS%
...
536 ' Animate death?
536 TIME=0
537 IF TIME>10 GOTO 539
538 IF TIME<5 OR STICK(S) THEN GOTO 537
539 GOTO 199
