...
160 call turbo ON(SX,SY,SV,SJ,R,C,PL,S)
...
856 TX=1:TY=6:T$="WHY TOOK YOU SO LONG]":GOSUB 890
857 IF TIME<250 GOTO 857
858 TX=1:TY=9:T$="DOES NOT MATTER BECAUSE":GOSUB 890
859 TX=1:TY=11:T$="IT DOES NOT END HERE":GOSUB 890
860 IF TIME<400 GOTO 860
861 TX=1:TY=14:T$="STAY TUNED":GOSUB 890
