...
123 DIMAE(3):DIMDE(3):DIMPO(3):DIMTE(3):DIMMM(3):DIMMN(3):DIMME(3):DIMPM(3):DIMPI(3):DIMCE(3)
124 defint A-Z
130 R=0:C=1:PL=9
...
800 A$ = CHR$(34) + "over.scr" + CHR$(34) + ",S" + CHR$(0)
801 '#I &h21,a$,&h23,&hdd,&h2a,&hCA,&h39,&hcd,&h59,&h01
810 IF INKEY$<>"" GOTO 810
820 IF INKEY$="" GOTO 820
830 GOTO 900

850 'Ending Screen
850 A$ = CHR$(34) + "end.scr" + CHR$(34) + ",S" + CHR$(0)
851 '#I &h21,a$,&h23,&hdd,&h2a,&hCA,&h39,&hcd,&h59,&h01
852 TIME=0
