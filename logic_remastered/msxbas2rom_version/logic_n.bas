...
552 IF VPEEK(K)=0 THEN VPOKE K,1 ELSE RETURN
553 GOSUB 580
554 SOUND 3,&H3:SOUND 2,&H8A
555 SOUND 12,8:SOUND 13,4
560 RETURN

580 'Draw Keys
581 FOR I=0 TO 3
582   IF VPEEK(I)=1 THEN VPOKE &H1A42+2*I, 20+4*I:VPOKE &H1A43+2*I, 21+4*I:VPOKE &H1A62+2*I, 22+4*I:VPOKE &H1A63+2*I, 23+4*I
585   IF VPEEK(I)=2 THEN VPOKE &H1A42+2*I, 32+4*I:VPOKE &H1A43+2*I, 33+4*I:VPOKE &H1A62+2*I, 34+4*I:VPOKE &H1A63+2*I, 35+4*I
586 NEXT I
599 RETURN

600 'Open a lock
601 IF TV>=192 AND TV<=215 THEN K=TV\8-24 ELSE K=TH\8-24
610 IF VPEEK(K)<>1 THEN RETURN
611 VPOKE K,2
...
701 SPRITE OFF
705 FOR I=0 TO 4:PUT SPRITE I,(I*16,164),0,0:NEXT I
710 SX=X:SY=Y:SV=VY:SJ=PJ:SS=PS
730 IF PL<0 GOTO 800 
790 GOTO 151

800 'Game Over Screen, press any key or wait 3 seconds
801 CMD WRTSCR 3
802 TIME=0
803 IF STRIG(1) GOTO 803
804 IF INKEY$<>"" GOTO 804
810 IF TIME>250 GOTO 900
815 IF STRIG(1) OR INKEY$<>"" GOTO 823
820 GOTO 810
823 RETURN 900
...
910 IF STRIG(0) OR STRIG(1) GOTO 910
...
1900 TIME=0
1910 IF STRIG(0) OR STRIG(1) GOTO 900
1912 IF TIME>150 GOTO 900 ELSE GOTO 1910

1950 IF SP=19 THEN SP=20 ELSE SP=19
1960 PUT SPRITE 0,,,SP
1970 RETURN
...
6000 IF TIME<100 GOTO 6000 ELSE GOTO 900
...
8150 CMD WRTSCR 4
8160 PUT SPRITE 0,(0,0),0:PUT SPRITE 1,(16,0),0:PUT SPRITE 2,(32,0),0
8510 TIME=0
...
8810 TX=0:TY=13:T$="APPLYING SEEMED A GOOD IDEA@":GOSUB 2000
...
9770 TIME=0
9780 IF TIME<150 GOTO 9780 ELSE GOTO 3000
