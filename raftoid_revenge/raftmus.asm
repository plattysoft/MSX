...
;Pautas (instrumentos)
;Instrumento 'Wave'
PAUTA_0:	DB	9,0,76,0,11,0,9,0,8,4,8,4,8,0,8,0,8,-4,8,-4,8,0,8,0,136
;Instrumento 'Orn 0-3-7'
PAUTA_1:	DB	8,0,8,0,24,3,24,3,24,7,24,7,134
;Instrumento 'Orn 0-4-7'
PAUTA_2:	DB	8,0,8,0,24,4,24,4,24,7,24,7,134
;Instrumento 'Orn 0-4-8'
PAUTA_3:	DB	8,0,8,0,24,4,24,4,24,8,24,8,134
;Instrumento 'Bass'
PAUTA_4:	DB	45,0,44,0,10,0,8,0,7,0,129
;Instrumento 'Clip'
PAUTA_5:	DB	72,0,72,0,40,0,8,2,8,2,7,0,7,0,8,-2,8,-2,7,0,7,0,136
;Instrumento 'AlarmUp'
PAUTA_6:	DB	8,0,8,0,8,0,8,0,8,-1,129
...
;Efecto 'Ball_indestructible'
SONIDO4:	DB	64,9,1,255
;Efecto 'Ball_regular'
SONIDO5:	DB	254,9,0,170,8,0,127,7,0,255
;Efecto 'Ball_inverted'
SONIDO6:	DB	127,9,0,170,8,0,254,7,0,255
;Efecto 'Life_lost'
SONIDO7:	DB	127,8,0,170,8,0,214,8,0,254,9,0,104,24,0,172,23,0,253,21,0,255
;Efecto 'Life_earned'
SONIDO8:	DB	253,24,0,172,24,0,104,24,0,254,9,0,214,8,0,170,7,0,127,5,0,255
