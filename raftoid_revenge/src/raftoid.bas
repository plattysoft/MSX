...
441 'IF TL=200 THEN TL=0:GOSUB 451

450 goto 100

451 'SCROLL THE BRICKS
451 FOR TY=23 TO 1 STEP -1
452   FOR TX=1 TO 22
453     TT=VPEEK (&H1800+TX+(TY-1)*32)
454     IF TT>9 AND TT<48 THEN VPOKE &H1800+TX+TY*32, TT
455   NEXT TX
456 NEXT TY
458 'FOR TX=1 TO 20
460   'VPOKE &H1800+X, RND(1)*8
461 'NEXT TX
