...
200 ' PIPE MOVEMENT
210 FOR I=0 TO 3:PX(I)=PX(I)-2
220 PUTSPRITE 1,(PX(I),15),2,8
221 PUTSPRITE 2,(PX(I),31),2,5
222 PUTSPRITE 3,(PX(I),47),2,8
223 PUTSPRITE 4,(PX(I),63),2,7
231 PUTSPRITE 5,(PX(I),143),2,6
232 PUTSPRITE 6,(PX(I),159),2,5
240 IF PX(I)<=0 THEN PX=175
241 NEXT I
