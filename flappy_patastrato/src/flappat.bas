...
200 ' PIPE MOVEMENT
210 FOR I=0 TO 2:PX(I)=PX(I)-2:SP=I*7
211 IF PE(I) GOSUB 1500 ' Move Pipe
241 NEXT I
350 IF T=30 THEN GOSUB 1700:T=0:CP=CP+1:IF CP=3 THEN CP=0
...
1500 ' Move pipe
1510 PX(I)=PX(I)-1
1520 IF PX(I)<=0 THEN PX(I)=175:PE(I)=0
1530 GOSUB 1600
1599 RETURN

1600 ' Draw Pipe (5-8)-7 [hole] 6-(5-8)
1601 IF PE(I)=0 THEN PC=0 ELSE PC=2
1610 PUTSPRITE 1+SP,(PX(I),PY(I,0)),PC,8
1620 PUTSPRITE 2+SP,(PX(I),PY(I,1)),PC,5
1630 PUTSPRITE 3+SP,(PX(I),PY(I,2)),PC,8
1640 PUTSPRITE 4+SP,(PX(I),PY(I,3)),PC,5
1650 PUTSPRITE 5+SP,(PX(I),PY(I,4)),PC,7
1660 PUTSPRITE 6+SP,(PX(I),PY(I,5)),PC,6
1699 RETURN
...
4100 LINE (15,15)-(175,175),4,BF
4110 GOSUB 2010 ' Load Bricks
4120 FOR I=2 to 21: VPOKE &H1800+i, i MOD 2: VPOKE &H1800+i+32, (i+1) MOD 2: next i
4130 FOR I=2 to 21: VPOKE &H1800+i+32*22, (i+1) MOD 2: VPOKE &H1800+i+32*23, i MOD 2:next i
