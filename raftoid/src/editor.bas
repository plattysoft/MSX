...
90 PUT SPRITE 1,,0: PUT SPRITE 2,,0
92 x=8:y=8:sa=0:sb=1
94 BLOAD "editor.scr",S
95 GOSUB 700
...
800 ' Export level
800 TX=5:TY=16:T$="stttttttttu":GOSUB 9090
801 TX=5:TY=17:T$="v;SAVING..w":GOSUB 9090
802 TX=5:TY=18:T$="xyyyyyyyyyz":GOSUB 9090
...
2100 CLOSE #1
2120 SS=0: Y=88: OY=80: TL=CL-1
2130 IF TL<9 THEN TX=2:TY=TL+12:T$="._NEW_.":GOSUB 9090
...
2250 IF S=5 AND Y<96+TL*8 THEN Y=Y+8
...
3400 'EDIT
3400 IF OY=80 THEN CL=(Y-88)/8: GOTO 3600' CREATE NEW LEVEL IF NEEDED
3410 'DELETE
...
3500 ' DELETE LEVEL
3500 CL=(Y-88)/8: IF TL=0 OR CL>TL GOTO 3000
...
3600 'CREATE NEW LEVEL IF NEEDED
3600 TX=5:TY=16:T$="stttttttttttu":GOSUB 9090
3601 TX=5:TY=17:T$="v;LOADING...w":GOSUB 9090
3602 TX=5:TY=18:T$="xyyyyyyyyyyyz":GOSUB 9090
3608 IF CL<=TL GOTO 90
3610 ' FIND THE FIRST STAGE NAME NOT IN USE
3610 I=0:TF=0
3620  'Verify we can use STAGE_I
3620  TT$="STAGE_"+CHR$(I+48)+".LVL"
3630  FOR J=0 TO TL
3631   IF LN$(J)=TT$ THEN TF=1:J=TL
3640  NEXT J
3650 IF TF=0 THEN GOTO 3680
3660 TF=0:I=I+1: GOTO 3620
3680 LN$(CL)=TT$:TL=TL+1:GOSUB 8000:GOSUB 900
3690 GOTO 90
...
9091   CT$=MID$(T$,i,1)
9092   IF CT$>="." AND CT$<="z" THEN VPOKE &H1800+tx+ty*32+i,ASC(CT$)
9093 NEXT I
9094 RETURN
