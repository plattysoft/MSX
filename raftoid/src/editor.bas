...
450 IF B$="S" OR B$="s" THEN put sprite 1,,0: GOTO 800
451 IF B$="B" OR B$="b" THEN put sprite 1,,0: GOTO 2000
500 goto 100
...
3440 IF OY=160 THEN PUT SPRITE 1,,0: PUT SPRITE 2,,0: RUN "raftoid.bas"
3450 'BACK
3450 IF OY=176 THEN PUT SPRITE 1,,0: PUT SPRITE 2,,0: RUN "start.bas"
3490 GOTO 3000
