...
815 BLOAD "cls.scr",S
816 T$="STAGE:":TX=10:TY=8:GOSUB 760
817 T$=STR$(L):TX=16-LEN(T$):TY=10:GOSUB 760
819 TIME=0
...
882 T$="STAGE:":TX=24:TY=18:GOSUB 760
883 T$=STR$(L):TX=30-LEN(T$):TY=20:GOSUB 760

890 goto 40

2500 ' Game over screen TODO Extract
2550 BLOAD "cls.scr",S
2560 T$="GAME OVER":TX=10:TY=5:GOSUB 760
2580 T$="SCORE:":TX=5:TY=10:GOSUB 760
2581 T$="000000":TX=5:TY=12:GOSUB 760
2582 TS$=STR$(sd):T$=RIGHT$(TS$,LEN(TS$)-1):TX=8-LEN(T$):TY=12:GOSUB 760
2583 TS$=STR$(sc):T$=RIGHT$(TS$,LEN(TS$)-1):TX=11-LEN(T$):TY=12:GOSUB 760
2591 T$="STAGE:":TX=19:TY=10: GOSUB 760
2592 T$=STR$(l):TX=25-LEN(T$):TY=12:GOSUB 760
2593 T$="PRESS ANY KEY":TX=9:TY=18:GOSUB 760
...
4200 NEXT K
4210 T$="SCORE:":TX=24:TY=0:GOSUB 760
4211 T$="000000":TX=24:TY=2:GOSUB 760:se=1:GOSUB 777
4220 T$="LIVES:":TX=24:TY=6:GOSUB 760
4221 GOSUB 770
4299 RETURN
